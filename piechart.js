...
function pieChart() {
  ...
  // Config settings
  var chartSizePercent = 85;                        // The chart radius relative to the canvas width/height (in percent)
  ...
  var pullOutLabelPadding = 150;                     // Padding between pulled-out slice and its label  
  var pullOutLabelFont = "bold 13px 'Trebuchet MS', Verdana, sans-serif";  // Pull-out slice label font
  var pullOutValueFont = "bold 11px 'Trebuchet MS', Verdana, sans-serif";  // Pull-out slice value font
